...
Mention an active workspace user with `@` when you need to bring them into the discussion. They receive a notification that links back to the comment.
...
Upcoming excursion reminders use the departure time. The excursion creator and users listed in the Staffing tab are notified when a visible, non-archived excursion is 30, 14, 7, or 1 days away.
