...
description: "Design fields, configure publishing settings, and review responses in the form builder. Submissions are tracked alongside each form for easy follow-up."
---
