...
description: "Upload a CSV or Excel file of parent records, validate each row locally in the browser, and import only the rows that pass without errors."
---
...
Use the combined people import when your spreadsheet needs to link parents or guardians with students as part of the import. It supports student rows, parent rows, and relationship details in one workflow so family links can be created alongside the people records.
